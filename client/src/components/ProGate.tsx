...
const MODAL_COPY: Record<ModalTrigger, SportCopy> = {
  NBA: {
    ...
    subhead: "High-conviction signals with signal strength, sharp money context, and market-aware edges — every game, fully readable.",
    ...
    features: [
      ...
      { icon: BarChart2,    label: "Action windows",            detail: "Playable range and timing notes for every strong signal." },
  ...
  MLB: {
    ...
    features: [
      ...
      { icon: BarChart2,    label: "Action takeaways",          detail: "Run-line, total, and prop angles for every strong signal." },
  ...
  NFL: {
    ...
    subhead: "High-conviction signals with signal strength, injury context, and market-aware edges — every week, fully readable.",
    cta: "Unlock Pro — $19/mo",
    features: [
      ...
      { icon: BarChart2,    label: "Action takeaways",          detail: "Spread, total, and prop actions for every strong signal." },
  ...
  CFB: {
    ...
    features: [
      ...
      { icon: BarChart2,    label: "Action takeaways",          detail: "ATS, total, and player prop actions for every strong signal." },
  ...
  generic: {
    ...
    subhead: "High-conviction signals with signal strength, context, and market-aware edges — so you act before the rest of the market catches up.",
    cta: "Unlock Pro — $19/mo",
    features: [
