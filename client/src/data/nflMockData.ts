...
export const NFL_SIGNALS: NFLSignal[] = [
  ...
  },
  {
    ...
    detail: "KC opened at -3.5 Sunday night and moved to -5.5 by Wednesday afternoon. 68% of spread tickets are on Buffalo, but 71% of the money is on KC — classic sharp fade of public sentiment. Three steam moves logged at Pinnacle (8 AM, 11 AM, 2 PM) — all KC side.",
    why_it_matters: "When ticket count and money percentage diverge this sharply early in the week, it reflects syndicate or professional action. Public is fading KC; sharp money is not.",
    ...
    lineMovement: {
      ...
      current: "KC -5.5",
      direction: "down",
      note: "71% sharp handle vs 68% public tickets on BUF — sharp-driven",
    },
    proOnly: true,
    bettingRelevance: true,
  ...
  },
  {
    ...
    team: "PHI",
    opponent: "GB",
    headline: "PHI receiving 23% of tickets, 67% of sharp money — classic steam",
    detail: "Sharp money has been hammering Eagles -2.5 since a line hook opened Thursday morning. Three syndicate moves logged between 8–11 AM. Public is heavily on Green Bay (home field narrative). Reverse line movement is confirmed — GB is getting tickets but PHI is moving.",
    why_it_matters: "Steam moves with this profile — public on one side, sharp money heavy on the other — hit at 58%+ ATS over large historical samples. Syndicate action is rarely wrong this early in the week.",
    ...
    lineMovement: {
      ...
      current: "PHI -2.5",
      direction: "down",
      note: "67% sharp money PHI vs 23% public tickets — reverse line movement",
    },
    proOnly: true,
    bettingRelevance: true,
    fantasyRelevance: false,
