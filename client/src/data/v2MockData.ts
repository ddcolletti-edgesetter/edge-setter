...
export const NBA_SIGNALS: V2Signal[] = [
  ...
  },
  {
    ...
    detail: "Line moved 1.5 points across Pinnacle, Circa, and DraftKings within a 90-minute window with reverse public action. Public money is 61% on MIA but 80% of tracked professional activitys are on BOS. Ticket split does not explain the move — this is sharp-driven. Opened at -6 Sunday night.",
  ...
  },
  {
    ...
    detail: "GSW/LAL game environment opened at 214.5 and has climbed to 218.5 at Pinnacle, 218 at DraftKings. Professional handle is 77% on the Over despite only 45% of public tickets. Three separate external shifts were detected in the last 6 hours.",
    why_it_matters: "Context shifts of this magnitude in a playoff game usually trace to legitimate professional activity. Both teams have exceeded their projected scoring marks in 4 of 5 games this series.",
    ...
    lineMovement: {
      ...
      current: "218.5",
      direction: "up",
      note: "+4 points, 77% professional activitys on Over vs 45% public",
    },
    bettingRelevance: true,
    fantasyRelevance: false,
    hitRateStub: null,
...
export const MLB_SIGNALS: V2Signal[] = [
  ...
  },
  {
    ...
    detail: "Opening external movement of 2 full points, driven primarily by professional activity at Pinnacle and Circa. Public split is 53% on KC but 84% of tracked professional activity is KC-side. This is one of the cleanest supporting context signals of the week.",
    ...
    lineMovement: {
      ...
      current: "KC -5.5",
      direction: "down",
      note: "2-pt move crossing 4/4.5/5 — sharp-driven, 84% professional activity KC",
    },
    bettingRelevance: true,
    fantasyRelevance: false,
    hitRateStub: null,
